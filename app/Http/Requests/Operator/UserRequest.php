...
class UserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'id_number' => $isPurokLeader
                ? ['required', 'regex:/^\d+$/', $isUpdate ? 'unique:officials_details,id_number,'.$userId.',user_id' : 'unique:officials_details,id_number']
                : 'nullable',
        ];
    }
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'id_number.regex' => 'ID Number must contain digits only.',
