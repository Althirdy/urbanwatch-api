...
export const deviceStatusColors = {
    active: 'bg-green-700 rounded-full dark:bg-green-800',
    maintenance: 'bg-orange-100 rounded-full dark:bg-orange-700',
    inactive: 'bg-gray-100 rounded-full dark:bg-zinc-600',
} as const;
