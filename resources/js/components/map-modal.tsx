...
export function MapModal({ onLocationSelect, onPackageSelect, selectedPackage, coordinates }: MapModalProps) {
    const [open, setOpen] = useState(false);

    const handleLocationSelect = (location: { lat: number; lng: number }) => {
        onLocationSelect(location);
        // Don't close modal automatically - let user see the selection and close manually
    };
