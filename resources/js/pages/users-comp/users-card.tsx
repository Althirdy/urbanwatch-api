...
const UserCard = ({
    ...
    const getFullName = (user: users_T) => {
        ...
        if (user.official_details) {
            fullName = `${user.official_details.first_name} ${user.official_details.middle_name || ''} ${user.official_details.last_name}`.trim();
        }
        if (user.citizen_details) {
            fullName = `${user.citizen_details.first_name} ${user.citizen_details.middle_name || ''} ${user.citizen_details.last_name}`.trim();
        }
