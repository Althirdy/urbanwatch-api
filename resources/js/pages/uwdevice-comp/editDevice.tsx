...
function EditUWDevice({ location, device, cctvDevices }: EditUWDeviceProps): React.JSX.Element {
    ...
    const onSubmit = (e: React.FormEvent) => {
        ...
        const formData = {
            ...
            latitude: useCustomLocation ? parseFloat(coordinates.latitude) : null,
            longitude: useCustomLocation ? parseFloat(coordinates.longitude) : null
        };

        console.log('Submitting edit form data:', formData);

        // Submit to backend using Inertia
        router.put(`/devices/uw/${device.id}`, formData, {
            onSuccess: () => {
                toast({
                    title: "Success!",
